...
while { true } do {
	...
	if ( _myfps < 10 ) then { _myfpsmarker setMarkerColor CONST_COLOR_OPFOR_BRIGHT; };

	_myfpsmarker setMarkerText format [ "%1: %2 fps, %3 units, %4 vehicles", _sourcestr, _myfps, _localunits, _localvehicles ];
