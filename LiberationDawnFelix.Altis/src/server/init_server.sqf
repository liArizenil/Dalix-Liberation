...
[] spawn compileFinal preprocessFileLineNumbers "src\server\loop\loop_offload_manager.sqf";
[] spawn compileFinal preprocessFileLineNumbers "src\server\loop\loop_offload.sqf";
[] spawn compileFinal preprocessFileLineNumbers "src\server\loop\loop_permissions.sqf";
[] spawn compileFinal preprocessFileLineNumbers "src\server\loop\loop_reinforcements_resetter.sqf";
[] spawn compileFinal preprocessFileLineNumbers "src\server\loop\loop_scores.sqf";
