if ( isMultiplayer ) then {
	...
	player_permissions_param = ["Permissions",1] call bis_fnc_getParamValue;
...
if ( player_permissions_param == 1 ) then { player_permissions_param = true } else { player_permissions_param = false };
