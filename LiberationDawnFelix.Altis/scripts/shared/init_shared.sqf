...
banplayer_remote_call = compileFinal preprocessFileLineNumbers "scripts\server\remotecall\banplayer_remote_call.sqf";
updateammo_remote_call = compileFinal preprocessFileLineNumbers "scripts\server\remotecall\updateammo_remote_call.sqf";
addammo_remote_call = compileFinal preprocessFileLineNumbers "scripts\server\remotecall\addammo_remote_call.sqf";

remote_call_setammo = compileFinal preprocessFileLineNumbers "scripts\client\remotecall\remote_call_setammo.sqf";
