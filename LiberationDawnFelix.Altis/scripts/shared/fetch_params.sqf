if ( isMultiplayer ) then {
	...
	GRLIB_Opfor_respawn_timer = ["OPFORInfRespawnTimer",0] call bis_fnc_getParamValue;
	GRLIB_Opfor_Air_respawn_timer = ["OPFORAirRespawnTimer",0] call bis_fnc_getParamValue;
} else {
