...
if ( isNil "huron_typename" ) then { huron_typename = "I_Heli_Transport_02_F"; };
...
heavy_vehicles = [
	...
	["B_T_APC_Tracked_01_AA_F",135,110,150],
	["I_MBT_03_cannon_F",150,150,150],
	["B_MBT_01_cannon_F",135,135,150],
	["B_T_MBT_01_cannon_F",135,135,150],
	["B_MBT_01_TUSK_F",135,150,150],
	["B_T_MBT_01_TUSK_F",135,150,150],
	["B_AFV_Wheeled_01_cannon_F",120,135,120],
	["B_T_AFV_Wheeled_01_cannon_F",120,135,120],
	["B_AFV_Wheeled_01_up_cannon_F",120,150,120],
	["B_T_AFV_Wheeled_01_up_cannon_F",120,150,120],
