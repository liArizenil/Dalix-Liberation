...
[gamelogic, format["%1님에 의해 FOB %2의 %3이(가) 재활용되었습니다", name _player, [[_player] call F_getNearestFob] call F_getFobName, getText (configFile >> "cfgVehicles" >> typeOf _object_recycled >> "displayName" ) ]] remoteExec ["globalChat",[WEST,civilian]];
