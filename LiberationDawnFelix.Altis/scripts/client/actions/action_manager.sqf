...
*/
	...
	if((_fobdistance < (_distfob + 25) || (player distance _whiskey) < 100) && alive player && vehicle player == player && ([getPos player , 1500 , GRLIB_side_enemy ] call F_getUnitsCount) > 0) then {
