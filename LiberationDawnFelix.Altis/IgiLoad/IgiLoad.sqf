...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Vehicles_MOHAWK = ["I_Heli_Transport_02_F","C_IDAP_Heli_Transport_02_F","B_Heli_Transport_03_F", "B_Heli_Transport_03_unarmed_F"];
	...
	IL_Supported_Supply_Crate = ["B_supplyCrate_F", "IG_supplyCrate_F", "O_supplyCrate_F", "I_supplyCrate_F", "C_supplyCrate_F","Box_NATO_Equip_F"];
